...
let CompanyManagementService = class CompanyManagementService {
    ...
    async getAllCompanies() {
        return await connection_1.db.select().from(company_management_entity_1.companies).where((0, drizzle_orm_1.eq)(company_management_entity_1.companies.is_active, true));
    }
    async getCompanyById(id) {
        ...
        const company = await connection_1.db
            ...
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(company_management_entity_1.companies.id, companyId), (0, drizzle_orm_1.eq)(company_management_entity_1.companies.is_active, true)))
            .limit(1);
        if (!company.length) {
    ...
    async updateCompany(id, updateCompanyDto) {
        try {
            ...
            const [updatedCompany] = await connection_1.db
                ...
                .set(updateData)
                .where((0, drizzle_orm_1.eq)(company_management_entity_1.companies.id, parseInt(id)))
                .returning();
            if (!updatedCompany) {
                throw new common_1.NotFoundException('Company not found');
            }
    ...
    async createBranch(createBranchDto) {
        try {
            ...
            const [branch] = await connection_1.db
                .insert(company_management_entity_1.branches)
                .values({
    ...
    async getAllBranches() {
        return await connection_1.db.select().from(company_management_entity_1.branches).where((0, drizzle_orm_1.eq)(company_management_entity_1.branches.is_active, true));
    }
    async getBranchesByCompany(companyId) {
        return await connection_1.db
            .select()
            .from(company_management_entity_1.branches)
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(company_management_entity_1.branches.company_id, parseInt(companyId)), (0, drizzle_orm_1.eq)(company_management_entity_1.branches.is_active, true)));
    }
    async getBranchById(id) {
        const branch = await connection_1.db
            .select()
            .from(company_management_entity_1.branches)
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(company_management_entity_1.branches.id, parseInt(id)), (0, drizzle_orm_1.eq)(company_management_entity_1.branches.is_active, true)))
            .limit(1);
        if (!branch.length) {
    ...
    async updateBranch(id, updateBranchDto) {
        try {
            ...
            const [updatedBranch] = await connection_1.db
                .update(company_management_entity_1.branches)
                .set(updateData)
                .where((0, drizzle_orm_1.eq)(company_management_entity_1.branches.id, parseInt(id)))
                .returning();
            if (!updatedBranch) {
                throw new common_1.NotFoundException('Branch not found');
            }
