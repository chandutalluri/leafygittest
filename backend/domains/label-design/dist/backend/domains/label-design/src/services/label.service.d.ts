...
export declare class LabelService {
    ...
    private readonly productOrchestratorUrl;
    private readonly directDataUrl;
    ...
    generateLabelPreview(templateId: number, productId: number, branchId?: number): Promise<{
        success: boolean;
        data: {
            templateId: number;
            productId: number;
    ...
    generateBatchPreview(templateId: number, productIds: number[], branchId?: number): Promise<{
        success: boolean;
        data: {
            templateId: number;
            productIds: number[];
    ...
    downloadPrintJobFile(jobId: number): Promise<{
        buffer: Buffer<ArrayBuffer>;
        filename: string;
        mimeType: string;
    }>;
    getSuitableTemplatesForProduct(productId: number): Promise<{
        success: boolean;
        data: {
            id: any;
            name: any;
    ...
    updateBranchSettings(branchId: number, newSettings: any): Promise<{
        success: boolean;
        data: any;
        message: string;
    }>;
    verifyLabelAuthenticity(serialNumber: string): Promise<{
        success: boolean;
        verified: boolean;
        message: string;
        data?: undefined;
    ...
    generateComplianceAudit(filters?: {
        branchId?: number;
        fromDate?: string;
        toDate?: string;
    }): Promise<{
    ...
    private generateLabelImage;
    private generateSerialNumbers;
    private calculateExpiryDate;
    private createPrintLog;
    private updateBranchSerialCounter;
    generateEnhancedQRCode(qrDto: {
        content: string;
