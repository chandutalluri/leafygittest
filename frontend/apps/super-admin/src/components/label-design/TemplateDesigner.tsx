...
export function TemplateDesigner({ onClose, onSave, editTemplate }: TemplateDesignerProps) {
  ...
  const validateTemplate = () => {
    ...
    const totalWidth =
      template.labelWidth * template.horizontalCount +
      template.horizontalGap * (template.horizontalCount - 1) +
      template.marginLeft +
      template.marginRight;

    const totalHeight =
      template.labelHeight * template.verticalCount +
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white border-2 border-gray-200 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
            ...
            <div>
              <Label htmlFor="templateType" className="text-gray-700 font-medium">
                Template Type
              </Label>
              <Select
            ...
            {/* Paper Settings */}
            <h3 className="text-lg font-semibold mt-6 text-gray-900 border-b border-gray-200 pb-2">
              Paper Settings
            </h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="paperWidth" className="text-gray-700 font-medium">
                  Paper Width (mm)
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'paperWidth',
                      safeParseFloat(e.target.value, template.paperWidth || 210)
                    )
                  }
              ...
              <div>
                <Label htmlFor="paperHeight" className="text-gray-700 font-medium">
                  Paper Height (mm)
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'paperHeight',
                      safeParseFloat(e.target.value, template.paperHeight || 297)
                    )
                  }
                  disabled={template.paperSize !== 'Custom'}
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500 disabled:bg-gray-100"
          ...
          <div className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="labelWidth" className="text-gray-700 font-medium">
                  Label Width (mm)
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'labelWidth',
                      safeParseFloat(e.target.value, template.labelWidth || 60)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
              ...
              <div>
                <Label htmlFor="labelHeight" className="text-gray-700 font-medium">
                  Label Height (mm)
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'labelHeight',
                      safeParseFloat(e.target.value, template.labelHeight || 30)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="horizontalCount" className="text-gray-700 font-medium">
                  Columns
                </Label>
                <input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'horizontalCount',
                      safeParseInt(e.target.value, template.horizontalCount || 3)
                    )
                  }
              ...
              <div>
                <Label htmlFor="verticalCount" className="text-gray-700 font-medium">
                  Rows
                </Label>
                <input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'verticalCount',
                      safeParseInt(e.target.value, template.verticalCount || 4)
                    )
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
            ...
            <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-xs text-blue-700">
                {template.horizontalCount} × {template.verticalCount} = {calculateTotalLabels()}{' '}
                labels per sheet
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="marginTop" className="text-gray-700 font-medium">
                  Top Margin
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'marginTop',
                      safeParseFloat(e.target.value, template.marginTop || 15)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
              ...
              <div>
                <Label htmlFor="marginBottom" className="text-gray-700 font-medium">
                  Bottom Margin
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'marginBottom',
                      safeParseFloat(e.target.value, template.marginBottom || 15)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="marginLeft" className="text-gray-700 font-medium">
                  Left Margin
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'marginLeft',
                      safeParseFloat(e.target.value, template.marginLeft || 10)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
              ...
              <div>
                <Label htmlFor="marginRight" className="text-gray-700 font-medium">
                  Right Margin
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'marginRight',
                      safeParseFloat(e.target.value, template.marginRight || 10)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="horizontalGap" className="text-gray-700 font-medium">
                  Horizontal Gap
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'horizontalGap',
                      safeParseFloat(e.target.value, template.horizontalGap || 5)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
              ...
              <div>
                <Label htmlFor="verticalGap" className="text-gray-700 font-medium">
                  Vertical Gap
                </Label>
                <Input
                  type="number"
                  ...
                  onChange={e =>
                    handleInputChange(
                      'verticalGap',
                      safeParseFloat(e.target.value, template.verticalGap || 5)
                    )
                  }
                  className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                />
            ...
            <div>
              <Label htmlFor="cornerRadius" className="text-gray-700 font-medium">
                Corner Radius (mm)
              </Label>
              <Input
                type="number"
                ...
                onChange={e =>
                  handleInputChange(
                    'cornerRadius',
                    safeParseFloat(e.target.value, template.cornerRadius || 0)
                  )
                }
                className="bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500"
              />
