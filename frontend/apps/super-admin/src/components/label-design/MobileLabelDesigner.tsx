...
export function MobileLabelDesigner() {
  ...
  const handleTouchStart = useCallback((e: React.TouchEvent, elementId?: string) => {
    ...
    touchTimeoutRef.current = setTimeout(() => {
      ...
      if (elementId) {
        ...
        toast.info('Element selected for editing');
  ...
  const addElement = useCallback((type: CanvasElement['type']) => {
    ...
    const newElement: CanvasElement = {
      ...
      width: type === 'text' ? 100 : type === 'qr' ? 40 : type === 'barcode' ? 80 : type === 'image' ? 60 : 80,
      height: type === 'text' ? 20 : type === 'qr' ? 40 : type === 'barcode' ? 30 : type === 'image' ? 60 : 20,
      content: type === 'text' ? 'Sample Text' : 
               type === 'qr' ? 'https://leafyhealth.com' :
                    ...
                    {element.type === 'rectangle' && (
                      <div
                        ...
                        style={{
                          ...
                          border: element.borderWidth ? `${element.borderWidth}px solid ${element.borderColor}` : '1px solid #6b7280'
                        }}
                      />
                    )}
