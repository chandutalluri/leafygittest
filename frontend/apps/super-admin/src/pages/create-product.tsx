      ...
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Create products with a single workflow that coordinates all five microservices:
            catalog management, inventory tracking, image handling, categorization, and label generation.
          </p>
        </div>
