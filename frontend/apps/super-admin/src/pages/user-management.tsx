        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-blue-700 text-sm">
              Create users and assign them to specific applications. Users cannot change their
              assigned app - only Super Admin can modify assignments.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                ...
                disabled={
                  !newUser.username.trim() || !newUser.email.trim() || !newUser.password.trim()
                }
